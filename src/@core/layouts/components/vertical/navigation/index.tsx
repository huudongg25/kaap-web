...
const Navigation = (props: Props) => {
  ...
  return (
    <Drawer {...props} navHover={navHover} setNavHover={setNavHover}>
      <VerticalNavHeader {...props} navHover={navHover} setNavHover={setNavHover} />
      ...
      <Box className='box-sonnh' sx={{ position: 'relative', overflow: 'hidden' }}>
        {/* @ts-ignore */}
        <ScrollWrapper
          {...(hidden
            ? {
        ...
        >
          ...
          {userNavMenuContent ? (
            ...
            <List className='nav-items sonnh' sx={{ pt: 0, '& > :first-child': { mt: '0' } }}>
              <VerticalNavItems
                navHover={navHover}
